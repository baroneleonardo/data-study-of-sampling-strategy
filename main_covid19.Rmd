...
# Plot the data
plot(log_nord,type = "l", lwd = 2, col = "#009999", xlab="Time", ylab="covid case",
     ylim = c(min(dati_finali_log),max(dati_finali_log)))
grid()
lines(log_centro, lwd = 2, col = "#FF3300")
legend(0,0, legend = c("nord", "centro"), lwd = 3, 
       cex=0.42, col = c("#009999","#FF3300"))
